...
if(isset($_POST['submit'])){
   ...
   # move_uploaded_file($temp_admin_image,"admin_images/$user_image");
    ...
    $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_country,admin_contact,admin_about) values ('$user_name','$user_email','$user_pass','$user_country','$user_contact','$user_about')";
