...
$customer_uname = $row_customer['customer_uname'];
...
<form action="" method="post" enctype="multipart/form-data"><!-- form Begin -->
    ...
    <div class="form-group"><!-- form-group Begin -->
      ...
      <div class="form-group"><!-- form-group Begin -->
        ...
        <input type="text" name="c_uname" class="form-control" value="<?php echo $customer_uname; ?>" required>
...
if(isset($_POST['update'])){
    ...
    $update_customer = "update customers set customer_name='$c_name',customer_uname='$c_uname',customer_email='$c_email',customer_country='$c_country',customer_city='$c_city',customer_address='$c_address',customer_contact='$c_contact' where customer_id='$update_id' ";
